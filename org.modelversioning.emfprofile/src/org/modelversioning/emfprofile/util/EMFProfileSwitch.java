	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EMFProfilePackage.PROFILE: {
				...
				if (result == null) result = caseEPackage(profile);
				if (result == null) result = caseENamedElement(profile);
			...
			case EMFProfilePackage.STEREOTYPE: {
				...
				if (result == null) result = caseEClass(stereotype);
				if (result == null) result = caseEClassifier(stereotype);
				if (result == null) result = caseENamedElement(stereotype);
