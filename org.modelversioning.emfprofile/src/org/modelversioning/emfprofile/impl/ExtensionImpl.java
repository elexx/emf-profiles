 ...
 *   <li>{@link org.modelversioning.emfprofile.impl.ExtensionImpl#getRedefining <em>Redefining</em>}</li>
 *   <li>{@link org.modelversioning.emfprofile.impl.ExtensionImpl#getSubsetting <em>Subsetting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionImpl extends EObjectImpl implements Extension {
	...
	/**
	 * The cached value of the '{@link #getRedefining() <em>Redefining</em>}' reference list.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getRedefining()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getSubsetting() <em>Subsetting</em>}' reference list.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getSubsetting()
	 * @generated
	 * @ordered
	...
	public EList<Extension> getRedefined() {
		if (redefined == null) {
			redefined = new EObjectWithInverseResolvingEList.ManyInverse<Extension>(Extension.class, this, EMFProfilePackage.EXTENSION__REDEFINED, EMFProfilePackage.EXTENSION__REDEFINING);
		}
		return redefined;
	}
	...
	public EList<Extension> getSubsetted() {
		if (subsetted == null) {
			subsetted = new EObjectWithInverseEList.ManyInverse<Extension>(Extension.class, this, EMFProfilePackage.EXTENSION__SUBSETTED, EMFProfilePackage.EXTENSION__SUBSETTING);
		}
		return subsetted;
	}
	...
	public EList<Extension> getRedefining() {
		if (redefining == null) {
			redefining = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse<Extension>(Extension.class, this, EMFProfilePackage.EXTENSION__REDEFINING, EMFProfilePackage.EXTENSION__REDEFINED);
		}
		return redefining;
	}
	...
	public boolean isSetRedefining() {
		return redefining != null && ((InternalEList.Unsettable<?>)redefining).isSet();
	}
	...
	public EList<Extension> getSubsetting() {
		if (subsetting == null) {
			subsetting = new EObjectWithInverseResolvingEList.Unsettable.ManyInverse<Extension>(Extension.class, this, EMFProfilePackage.EXTENSION__SUBSETTING, EMFProfilePackage.EXTENSION__SUBSETTED);
		}
		return subsetting;
	}
	...
	public boolean isSetSubsetting() {
		return subsetting != null && ((InternalEList.Unsettable<?>)subsetting).isSet();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case EMFProfilePackage.EXTENSION__REDEFINED:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRedefined()).basicAdd(otherEnd, msgs);
			case EMFProfilePackage.EXTENSION__SUBSETTED:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getSubsetted()).basicAdd(otherEnd, msgs);
			case EMFProfilePackage.EXTENSION__REDEFINING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRedefining()).basicAdd(otherEnd, msgs);
			case EMFProfilePackage.EXTENSION__SUBSETTING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getSubsetting()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case EMFProfilePackage.EXTENSION__REDEFINED:
				return ((InternalEList<?>)getRedefined()).basicRemove(otherEnd, msgs);
			case EMFProfilePackage.EXTENSION__SUBSETTED:
				return ((InternalEList<?>)getSubsetted()).basicRemove(otherEnd, msgs);
			case EMFProfilePackage.EXTENSION__REDEFINING:
				return ((InternalEList<?>)getRedefining()).basicRemove(otherEnd, msgs);
			case EMFProfilePackage.EXTENSION__SUBSETTING:
				return ((InternalEList<?>)getSubsetting()).basicRemove(otherEnd, msgs);
		}
